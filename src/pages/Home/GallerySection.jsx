...
export default function GallerySection() {
  ...
  return (
    <>
      <section id="gallery" className="py-24 lg:py-32 bg-bg" ref={ref}>
            ...
            <AnimatePresence mode="popLayout">
              {visibleImages.map((img, i) => (
                <motion.button
                  ...
                  className="group relative aspect-[4/3] overflow-hidden bg-bg-alt cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-text"
                >
                  <img
                    src={img.src}
                    alt={img.alt}
