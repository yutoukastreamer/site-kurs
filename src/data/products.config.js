...
export const products = {
  bulldozer: {
    slug: 'bulldozer',
    seo: {
      title: 'КУРС - отечественная безмачтовая система 3D нивелирования для бульдозера',
      description: 'Передовая безмачтовая система 3D-нивелирования КУРС позволяет улучшить точность и производительность вашего бульдозера',
      keywords: 'Безмачтовая система 3D нивелирования',
    },
    name: 'Бульдозер',
    ...
    description:
      '3D система нивелирования для бульдозера была разработана, чтобы сохранить вашу производительность на высоком уровне. Тем самым обеспечивая высокую скорость работы и максимальный контроль при планировке. Высокопродуктивное решение для выравнивания и распределения любых материалов на всех этапах строительства. Система может работать в 2-х режимах ГНСС и ЛПС.',
    features: [
  ...
  excavator: {
    slug: 'excavator',
    seo: {
      title: 'КУРС - отечественная индикаторная система 3D нивелирования для экскаватора',
      description: 'Передовая индикаторная система 3D-нивелирования КУРС позволяет улучшить точность и производительность вашего экскаватора',
      keywords: 'Индикаторная система 3D нивелирования',
    },
    name: 'Экскаватор',
    ...
    description:
      'Индикаторная 3D-система для экскаваторов обеспечивает в реальном времени динамическое изменение положения ковша на экране относительно текущего проекта, что позволяет оператору выполнять планировку или копание в точном соответствии с отметками. Система работает в двух режимах: ГНСС и ЛПС, что особенно актульно в условиях нестабильного сигнала ГНСС.',
    features: [
  ...
  grader: {
    slug: 'grader',
    seo: {
      title: 'КУРС - отечественная система 3D нивелирования для грейдера',
      description: 'Передовая система 3D-нивелирования КУРС позволяет улучшить точность и производительность вашего грейдера',
      keywords: 'система 3D нивелирования',
    },
    name: 'Грейдер',
