...
| 6 | Где купить | `WhereToBuy.jsx` | Офис Москва + филиалы + placeholder Яндекс Карт |
...
| — | Подвал | `Footer.jsx` | Слева: логотип ГСИ + слоган + логотипы Курс и Россия. Два столбца: навигация + контакты. Иконки соцсетей: Rutube, Telegram, Max, VK, YouTube |
