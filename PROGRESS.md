...
> Последнее обновление: 2026-04-09 (VideoSection — акцентный фон, боковые тексты-накладки, пауза/скролл-пауза, мобильный статичный плеер с fullscreen; Header скрывается на подвале)
...
| 5 | Видео | `VideoSection.jsx` | **Desktop (fluid.glass)**: 200vh sticky, фон = акцентный цвет машины (синий/янтарь/зелёный, без градиентов). Заголовок «Система в действии» слева, описание справа — наезжают на рамку видео и уходят по scroll. Cinematic zoom 0.55→1→0.55. Кнопка «Смотреть видео» рестартит со звуком, тексты исчезают. В watch-режиме доступны pause/close. Авто-пауза при скролле вне секции. **Mobile**: статичный горизонтальный плеер (aspect-video), заголовок над видео, кнопки play/pause/fullscreen, кастомный fullscreen-оверлей с X-кнопкой. |
...
| Cinematic zoom (fluid.glass) | Видео на продуктовых (desktop) | 200vh sticky, useMotionValue + manual scroll. scale 0.55→1→0.55, borderRadius 24→0→24. Левый заголовок и правое описание уезжают по X с fade. В watch-режиме тексты исчезают, появляются pause/close. Авто-пауза при скролле вне секции (IntersectionObserver) |
